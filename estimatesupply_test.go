...
func TestEstimateSupplyRefactored(t *testing.T) {
	est := &BlockByBlockSupplyEstimator{
		SubsidyCalculator: decredSubsidy,
	}
	for height, _ := range decredExpectedSubsidyEstimateValues {
		oldValue := EstimateDecredSupply(&decredSubsidy.subsidyParams, height, decredSubsidy.BlockOneSubsidy())
		newValue := est.Estimate(height)
...
var decredExpectedSubsidyEstimateValues = map[int64]int64{
	0:            0,
	1:            DecredMainNetSubsidy().PreminedCoins().AtomsValue,
	2:            168003119582664,
	4:            168009358747992,
	40:           168121663723896,
	400:          169244713482936,
